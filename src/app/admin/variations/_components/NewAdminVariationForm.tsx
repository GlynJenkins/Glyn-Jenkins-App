    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
      ...
      <label className="block">
        ...
        <p className="text-[10px] text-slate-400 mt-1">
          Assigned foremen can include this in their wage claim.
        </p>
      </label>
            ...
            return (
              <div key={line.lineId} className="flex gap-2 items-start">
                <select
                  ...
                  className="flex-1 px-2 py-2.5 border border-gray-200 rounded-xl text-sm bg-white min-w-0"
                >
                ...
                <input
                  ...
                  placeholder="Hrs"
                  className="w-20 px-2 py-2.5 border border-gray-200 rounded-xl text-sm"
                />
                {lines.length > 1 && (
                  <button
                    type="button"
                ...
                {lineTotal > 0 && (
                  <span className="text-xs text-slate-500 self-center tabular-nums shrink-0">
                    £{lineTotal.toFixed(2)}
                  </span>
                )}
              </div>
      ...
      <button
        ...
        className="w-full py-3.5 bg-orange-600 hover:bg-orange-700 disabled:opacity-50 text-white text-sm font-semibold rounded-xl flex items-center justify-center gap-2"
      >
